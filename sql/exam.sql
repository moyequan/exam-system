...
) ENGINE=InnoDB AUTO_INCREMENT=20230014 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='考试管理表';

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES ('20230001', '2023年上期期末考试', '计算机网络', '1001', '2023-03-21', '120', '2022', '1', '计算机科学与技术', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230002', '2023年上期期末考试', '数据库理论', '1002', '2023-03-07', '90', '2022', '2', '网络工程', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230003', '2023年下期期末考试', '数据结构', '1003', '2023-02-27', '90', '2022', '1', '软件工程', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230005', '2023年上期期末考试', '计算机导论', '1004', '2023-03-14', '90', '2022', '1', '计算机科学与技术', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230006', '2023年上期期末考试', '软件工程', '1005', '2023-03-21', '120', '2022', '1', '计算机科学与技术', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230007', '2023年上期期末考试', '操作系统', '1006', '2023-03-13', '120', '2022', '2', '计算机科学与技术', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230008', '2023年下期期末考试', 'C语言', '1007', '2023-03-13', '120', '2022', '1', '信息工程', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230009', '2023年上期期末考试', '高等数学', '1008', '2023-03-07', '90', '2022', '1', '信息工程', '软件工程学院', '100', '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES ('20230013', '测试', '测试', '1009', '2023-04-24', '120', '2022', null, '测试', '测试', '100', '期末考试', '请不要带与考试无关的书籍。');
...
) ENGINE=InnoDB AUTO_INCREMENT=10029 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='填空题题库';
...
CREATE TABLE `judge_question` (
  ...
  `section` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL COMMENT '所属章节',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10013 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='判断题题库表';
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='留言表';
...
INSERT INTO `message` VALUES ('39', 'asdasdasdasd', 'asdasdasdasd', '2023-12-18');
...
CREATE TABLE `multi_question` (
  ...
  `level` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10033 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='选择题题库表';
...
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES ('26', '3', '1111111', '2023-12-18');
INSERT INTO `replay` VALUES ('22', '4', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('25', '5', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('25', '6', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('21', '7', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('16', '8', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('15', '9', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('21', '11', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('20', '12', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('26', '13', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('27', '14', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('33', '18', '1111111', '2023-12-19');
INSERT INTO `replay` VALUES ('34', '19', '1111', '2023-12-19');
INSERT INTO `replay` VALUES ('34', '20', '2222', '2023-12-19');
INSERT INTO `replay` VALUES ('35', '21', '666', '2023-12-19');
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='成绩管理表';

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES ('4', '20220001', '20154084', '计算机网络', null, '70', null, '2023-12-19');
INSERT INTO `score` VALUES ('14', '20220002', '20154084', '数据库理论', null, '78', null, '2023-12-19');
INSERT INTO `score` VALUES ('15', '20220002', '20154084', '数据库理论', null, '80', null, '2023-12-19');
INSERT INTO `score` VALUES ('16', '20220002', '20154084', '数据库理论', null, '83', null, '2023-12-19');
INSERT INTO `score` VALUES ('17', '20220001', '20154001', '计算机网络', null, '74', null, '2023-12-19');
INSERT INTO `score` VALUES ('18', '20220001', '20154001', '计算机网络', null, '70', null, '2023-12-19');
INSERT INTO `score` VALUES ('19', '20220001', '20155003', '计算机网络', null, '86', null, '2023-12-19');
INSERT INTO `score` VALUES ('20', '20220001', '20155007', '计算机网络', null, '90', null, '2023-12-19');
INSERT INTO `score` VALUES ('21', '20220001', '20155007', '计算机网络', null, '92', null, '2023-12-19');
INSERT INTO `score` VALUES ('22', '20220001', '20155008', '计算机网络', null, '80', null, '2023-12-19');
INSERT INTO `score` VALUES ('23', '20220001', '20155003', '计算机网络', null, '90', null, '2023-12-19');
INSERT INTO `score` VALUES ('24', '20220001', '20155008', '计算机网络', null, '88', null, '2023-12-19');
INSERT INTO `score` VALUES ('27', '20220001', '20154084', '计算机网络', null, '80', null, '2023-12-19');
INSERT INTO `score` VALUES ('30', '20220001', '20154084', '计算机网络', null, '0', null, '2023-12-19');
INSERT INTO `score` VALUES ('31', '20220001', '20154084', '计算机网络', null, '0', null, '2023-12-19');
INSERT INTO `score` VALUES ('32', '20220013', '20154084', '测试', null, '0', null, '2023-12-19');
INSERT INTO `score` VALUES ('33', '20230001', '20154084', '计算机网络', null, '0', null, '2023-12-20');
INSERT INTO `score` VALUES ('34', '20230001', '20154084', '计算机网络', null, '0', null, '2023-12-20');
INSERT INTO `score` VALUES ('35', '20230001', '20154084', '计算机网络', null, '0', null, '2023-12-20');
INSERT INTO `score` VALUES ('36', '20230013', '20154084', '测试', null, '0', null, '2023-12-20');
INSERT INTO `score` VALUES ('37', '20230001', '20154084', '计算机网络', null, '0', null, '2023-12-20');
INSERT INTO `score` VALUES ('38', '20230013', '20154084', '测试', null, '0', null, '2023-12-20');
...
) ENGINE=InnoDB AUTO_INCREMENT=20155009 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='学生信息表';

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('20154001', '小明', '2022', '计算机科学与技术', '2', '软件工程学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2');
INSERT INTO `student` VALUES ('20154084', '小鱼', '2022', '计算机科学与技术', '2', '软件工程学院', '13658377857', '13658377857@sina.cn', '123456', '124123124535', '男', '2');
INSERT INTO `student` VALUES ('20155003', '张大宝', '2022', '信息工程', '1', '软件工程学院', '15583829425', '15583829425@163.com', '123456', '3242342', '男', '2');
INSERT INTO `student` VALUES ('20155007', '翠花', '2022', '网络工程', '1', '软件工程学院', '18734538457', '18734538457@163.com', '123456', '2423423', '女', '2');
INSERT INTO `student` VALUES ('20155008', '小王', '2022', '信息工程', '2', '软件工程学院', '15523619564', '15523619564@163.com', '123456', '500234199704022353', '男', '2');
...
) ENGINE=InnoDB AUTO_INCREMENT=20081003 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='教师信息表';
