        ...
        <div class="bottom">
          <div class="container">
            ...
            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
              ...
              <div class="options">
                <p class="find"><a href="javascript:;" @click="goToForgotPassword">找回密码</a></p>
                <div class="register">
                  <span>没有账号?</span>
                  <span><a href="javascript:;" @click="goToRegister">去注册</a></span>
                </div>
              </div>
            </el-form>
          </div>
...
export default {
  ...
  methods: {
    //用户登录请求后台处理
    goToRegister() {
    this.$router.push({path: '/register'}); // '/register' 是注册页面的路由路径
  },
  goToForgotPassword() {
      this.$router.push({ path: '/forgot-password' }); // '/forgot-password' 是找回密码页面的路由路径
    },
    login() {
      console.log("登录操作执行-------");
      this.$axios({
